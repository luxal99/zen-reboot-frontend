...
export class AddAppointmentDialogComponent extends DefaultComponent<Appointment> implements OnInit, AfterViewChecked {
  ...
  async save(): Promise<void> {
    ...
    appointment.staff = {
      id: this.appointmentForm.get(FormControlNames.STAFF_FORM_CONTROL)?.value.id,
      salaryCategory: {id: this.appointmentForm.get(FormControlNames.STAFF_FORM_CONTROL)?.value.salaryCategory.id},
    };
